  ...
  return (
    <div className="row m-0">
      <div className="col-12 text-center mb-4">
        <div className="instaHeading">Instagram Posts</div>
      </div>
          ...
          <div className="col-6 col-md-6 mb-4">
            {/* <div className="instaPosts"> */}
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/p/C8i3svAhlAa/?utm_source=ig_embed&amp;utm_campaign=loading"
              ...
              >
                <div style={{ padding: "16px" }}>
                  {" "}
                  <a
                    href="https://www.instagram.com/p/C8i3svAhlAa/?utm_source=ig_embed&amp;utm_campaign=loading"
                    style={{
                      background: "#FFFFFF",
                      lineHeight: 0,
                      padding: "0 0",
