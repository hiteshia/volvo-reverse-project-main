// Nextjs app router page for about plantation site

export default function AboutPlantation() {
  return (
    <>
        ...
        <div className="cstmContainer">
          <div className="col-12">
            <div className="row position-relative">
              <div className="col-12 text-center">
                <img
                  src="/images/about-plantation-bottom.png"
                  className="abtPlantationImg"
                />
              </div>
              <div className="col-12 abtPltnWhiteBg2"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row m-0">
          <div className="col-12">
            <div className="abtPlntBodyText mb-3">
              ...
              dignissim qui blandit pra awsedrfghjkml. quis nostrud exerci
              tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo
              consequat. Duis autem vel eum iriure dolor in hendrerit in
              vulputate.
            </div>
