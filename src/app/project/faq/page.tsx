          ...
          <div className="col-12">
            <Accordion className="px-3 px-md-0 apple-glass-accordion">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>Whether you own a Volvo or not, you can still be an eco-warrior & join the Reverse Project by registering your EV as a volunteer. Volvo will plant trees as you drive and provide you certificates, with the tree&apos;s geo-tagged location.</Accordion.Body>
              </Accordion.Item>
              ...
              <Accordion.Item eventKey="2">
                ...
                <Accordion.Body>
                  The objective of the Reverse Project by Volvo Car India as the name suggests is to reverse the damage caused to the environment. The Reverse Project by Volvo Car India, in collaboration with ASSOCHAM, is dedicated to converting a Ghaziabad urban dump yard into an Urban Forest,
                  fostering community participation to take the first steps in achieving this goal.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="3">
                <Accordion.Header>How many trees have been planted as a part of the Reverse Project?</Accordion.Header>
                <Accordion.Body>As part of the Reverse Project, Volvo Car India has already planted 10,000 trees at the urban dump yard in Ghaziabad and with every kilometre you drive, we will continue to plant more.</Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="4">
                ...
                <Accordion.Body>The Reverse Project&apos;s plantation site is Nagar Van, Pratap Vihar, Ghaziabad. Previously it was an urban dump yard.</Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="5">
                ...
                <Accordion.Body>
                  ...
                  <br />
                  - As an EV owner, 3 trees will be named after you for every 5000 km driven.
                  <br />- As a non-EV owner, 1 tree will be named after you, that are already planted under this initiative.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </div>
